...
parser.add_argument('--save_freq', type=float, default=6, help='Number of timesteps between file outputs.')
...
PETSc.Sys.Print(f"gamma*2/(g*dt) = {gamma.values()[0]*2/(g.values()[0]*dt)}")
